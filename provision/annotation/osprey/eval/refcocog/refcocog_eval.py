...
if __name__ == "__main__":
    ...
    parser.add_argument('--img', help='path to coco imgs', default='../images/coco/train2017')
    parser.add_argument('--json', help='path to refcocog val json file', default='./osprey/eval/refcocog/finetune_refcocog_val_with_mask.json')
    args = parser.parse_args()

    refcocog_eval = REFCOCOG_EVAL(args.model)
    refcocog_eval.forward(args.img, args.json, 
                          gt_file='osprey/eval/refcocog/captions_refcocog_gt.json', 
                          caption_file='osprey/eval/refcocog/captions_refcocog_osprey.json')
