...
if __name__ == "__main__":
    '''
    python osprey/eval/stage3_eval/eval_lvis_paco.py \
        --model exp/relation_description_summary_coco_sam_seem_box_segm/ \
        --json osprey/eval/stage3_eval/lvis_val_1k_category.json \
        --output osprey/eval/results/lvis_cls/relation_description_summary_coco_sam_seem_box_segm.json
    '''
    ...
    parser.add_argument('--json', help='path to lvis/paco val json file', default='osprey/eval/stage3_eval/lvis_val_1k_category.json')
    parser.add_argument('--output', help='path to save your result', required=True)
    args = parser.parse_args()

    lvis_paco_eval = LVIS_PACO_EVAL(args.model, args.bert)
    eval_result = lvis_paco_eval.eval(args.img, args.json)

    json.dump(eval_result, open(args.output, 'w'), indent=4)
