...
class GPT_EVAL(nn.Module):
    ...
    def forward(self, root_path, ann_file, out_file):
        final = []
...
if __name__ == "__main__":
    ...
    parser.add_argument('--json', help='ferret json file', 
                        default='./osprey/eval/ferret/box_refer_reason.json')
    parser.add_argument('--output', help='path to save your result', required=True,
                        default='./osprey/eval/ferret/orpsey_refer_reason.json'
                        )
    args = parser.parse_args()

    ferret_eval = GPT_EVAL(args.model)
    ferret_eval(args.img, args.json, args.output)
